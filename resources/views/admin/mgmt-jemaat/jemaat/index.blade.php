<x-admin>
    <x-slot:title>Jemaat</x-slot:title>

    <x-slot:button>
        <a href="{{ route('mgmt.jemaat.create') }}" class="btn btn-primary ms-auto"><i class="fa fa-plus-circle"
                    ...
                    @foreach ($jemaat as $jem)
                        <tr>
                            ...
                            <td class="font-medium">
                                <a href="{{ route('mgmt.jemaat.show', $jem->stambuk) }}">
                                    {{ $jem->nama }}
                                </a>
                            </td>
                            <td>
                            ...
                            <td class="inline-flex items-center text-center space-x-2">
                                <a href="{{ route('mgmt.jemaat.edit', $jem->stambuk) }}" class="badge badge-edit">
                                        ...
                                        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                            ...
                                            <div
                                                ...
                                                <div class="flex justify-center items-center space-x-4">
                                                    <button type="button" class="btn btn-slate"
                                                        data-modal-toggle="deleteModal-{{ $jem->stambuk }}">
                                                        Tidak Jadi
                                                    </button>
