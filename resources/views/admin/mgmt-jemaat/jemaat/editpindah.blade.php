<x-admin>
    <x-slot:title>edit jemaat pindah</x-slot:title>

    <x-slot:button>
        <a href="{{ route('mgmt.jemaatpindah.index') }}" class="btn btn-primary ms-auto"><i class="fa fa-undo my-auto"
                aria-hidden="true"></i> Kembali</a>
    </x-slot:button>

    <div class="card my-3">
        <div class="form-container">
            <form method="POST" action="{{ route('mgmt.jemaatpindah.update', $data[0]->stambuk) }}">
                @csrf
                @method('put')
