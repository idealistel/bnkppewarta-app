    ...
    <div x-show="showSuccess"
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            ...
            <div class="relative p-4 text-center bg-white rounded-lg shadow-2xl dark:bg-gray-800 sm:p-5">
                ...
                <p class="mb-4 text-md font-semibold text-gray-900 dark:text-white">
                    {{ session('success') }}
                </p>
                <button x-on:click="showSuccess = false" type="button"
                    class="py-2 px-3 mt-4 text-sm font-medium text-center text-white rounded-lg bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:focus:ring-primary-900">
                    Ok
                </button>
            </div>
        </div>
